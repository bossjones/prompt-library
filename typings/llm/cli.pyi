...
class AttachmentType(click.ParamType):
    name = ...
    def convert(self, value, param, ctx): # -> Attachment:
        ...



def attachment_types_callback(ctx, param, values): # -> list[Any]:
    ...
...
def keys_path_command(): # -> None:
    "Output the path to the keys.json file"
    ...

@keys.command(name="get")
@click.argument("name")
def keys_get(name): # -> None:
    """
...
def models_list(options, async_): # -> None:
    "List available models"
    ...

@models.command(name="default")
@click.argument("model", required=False)
def models_default(model): # -> None:
...
def aliases_set(alias, model_id): # -> None:
    """
...
def aliases_path(): # -> None:
    "Output the path to the aliases.json file"
    ...

@cli.command(name="plugins")
@click.option("--all", help="Include built-in default plugins", is_flag=True)
def plugins_list(all): # -> None:
...
@click.argument("name")
def templates_show(name): # -> None:
    "Show the specified prompt template"
    ...

@templates.command(name="edit")
@click.argument("name")
def templates_edit(name): # -> None:
    "Edit the specified prompt template using the default $EDITOR"
    ...

@templates.command(name="path")
def templates_path(): # -> None:
...
def install(packages, upgrade, editable, force_reinstall, no_cache_dir): # -> None:
...
def embed(collection, id, input, model, store, database, content, binary, metadata, format_): # -> None:
...
@click.option("-d", "--database", type=click.Path(file_okay=True, allow_dash=False, dir_okay=False, writable=True), envvar="LLM_EMBEDDINGS_DB")
def similar(collection, id, input, content, binary, number, database): # -> None:
    """
...
def embed_models_default(model, remove_default): # -> None:
...
@click.option("json_", "--json", is_flag=True, help="Output as JSON")
def embed_db_collections(database, json_): # -> None:
...
@click.argument("collection")
@click.option("-d", "--database", type=click.Path(file_okay=True, allow_dash=False, dir_okay=False, writable=True), envvar="LLM_EMBEDDINGS_DB", help="Path to embeddings database")
def collections_delete(collection, database): # -> None:
    """
...
def get_history(chat_id): # -> tuple[None, list[Any]] | tuple[Any | None, Generator[dict[Any, Any], None, None]]:
    ...

def render_errors(errors): # -> LiteralString:
    ...
