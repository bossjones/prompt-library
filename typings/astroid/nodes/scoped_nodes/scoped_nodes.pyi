...
def function_to_method(n, klass): # -> BoundMethod | FunctionDef | UnboundMethod:
    ...
...
class Module(LocalsDictNodeNG):
    ...
    def stream(self): # -> BytesIO | BufferedReader | None:
    ...
    def getattr(self, name, context: InferenceContext | None = ..., ignore_locals=...): # -> list[InferenceResult | Any | Module]:
        ...
    ...
    def wildcard_import_names(self): # -> list[str] | list:
    ...
    def get_children(self): # -> Generator[NodeNG, Any, None]:
        ...
...
class GeneratorExp(ComprehensionScope):
    ...
    def get_children(self): # -> Generator[NodeNG | Comprehension, Any, None]:
        ...
...
class Lambda(_base_nodes.FilterStmtsBaseNode, LocalsDictNodeNG):
    ...
    def get_children(self): # -> Generator[Arguments | NodeNG, Any, None]:
        ...
...
class FunctionDef(_base_nodes.MultiLineBlockNode, _base_nodes.FilterStmtsBaseNode, _base_nodes.Statement, LocalsDictNodeNG):
    ...
    def postinit(self, args: Arguments, body: list[NodeNG], decorators: node_classes.Decorators | None = ..., returns=..., type_comment_returns=..., type_comment_args=..., *, position: Position | None = ..., doc_node: Const | None = ..., type_params: (list[nodes.TypeVar | nodes.ParamSpec | nodes.TypeVarTuple] | None) = ...): # -> None:
    ...
    def infer_yield_result(self, context: InferenceContext | None = ...): # -> Generator[InferenceResult | Const, Any, None]:
    ...
    def get_children(self): # -> Generator[Decorators | Arguments | Any | TypeVar | ParamSpec | TypeVarTuple | NodeNG, Any, None]:
        ...
...
def get_wrapping_class(node): # -> ClassDef | None:
...
class ClassDef(_base_nodes.FilterStmtsBaseNode, LocalsDictNodeNG, _base_nodes.Statement):
    ...
    def implicit_locals(self): # -> tuple[tuple[str, Any], tuple[str, Any], tuple[str, Any]]:
    ...
    newstyle = ...
    @cached_property
    def blockstart_tolineno(self): # -> int | Any:
        """The line on which the beginning of this block ends.
    ...
    @property
    def basenames(self): # -> list[str | Any]:
    ...
    def local_attr_ancestors(self, name, context: InferenceContext | None = ...): # -> Generator[ClassDef, Any, None]:
    ...
    def instance_attr_ancestors(self, name, context: InferenceContext | None = ...): # -> Generator[ClassDef, Any, None]:
    ...
    def local_attr(self, name, context: InferenceContext | None = ...): # -> list[InferenceResult]:
    ...
    def instance_attr(self, name, context: InferenceContext | None = ...): # -> list:
    ...
    def getitem(self, index, context: InferenceContext | None = ...): # -> Any | UninferableBase | Self:
    ...
    def methods(self): # -> Generator[FunctionDef, Any, None]:
    ...
    def mymethods(self): # -> Generator[FunctionDef, Any, None]:
    ...
    def implicit_metaclass(self): # -> NodeNG | None:
    ...
    def slots(self): # -> list[NodeNG | None] | None:
        ...
    ...
    def get_children(self): # -> Generator[SuccessfulInferenceResult | Decorators | Keyword | TypeVar | ParamSpec | TypeVarTuple, Any, None]:
        ...
