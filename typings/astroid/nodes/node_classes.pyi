...
def unpack_infer(stmt, context: InferenceContext | None = ...): # -> Generator[SuccessfulInferenceResult | Any | UninferableBase, Any, dict[str, Any]]:
...
class BaseContainer(_base_nodes.ParentAssignNode, Instance, metaclass=abc.ABCMeta):
    ...
    def itered(self): # -> list[SuccessfulInferenceResult]:
    ...
    def get_children(self): # -> Generator[SuccessfulInferenceResult, Any, None]:
        ...
...
class Arguments(_base_nodes.AssignTypeNode):
    ...
    @cached_property
    def arguments(self): # -> list[AssignName]:
    ...
    def default_value(self, argname): # -> NodeNG | None:
    ...
    def find_argname(self, argname, rec=...): # -> tuple[int | None, Any] | tuple[None, None]:
    ...
    def get_children(self): # -> Generator[AssignName | NodeNG, Any, None]:
        ...
...
class AnnAssign(_base_nodes.AssignTypeNode, _base_nodes.Statement):
    ...
    assigned_stmts = ...
    def get_children(self): # -> Generator[Name | Attribute | Subscript | NodeNG, Any, None]:
        ...
...
class Call(NodeNG):
    ...
    def get_children(self): # -> Generator[NodeNG | Keyword, Any, None]:
        ...
...
class Const(_base_nodes.NoChildrenNode, Instance):
    ...
    def getitem(self, index, context: InferenceContext | None = ...): # -> Const:
    ...
    def itered(self): # -> list[ConstFactoryResult]:
        """An iterator over the elements this node contains.
...
class Dict(NodeNG, Instance):
    ...
    def get_children(self): # -> Generator[InferenceResult, Any, None]:
    ...
    def last_child(self): # -> InferenceResult | None:
        """An optimized version of list(get_children())[-1]
    ...
    def itered(self): # -> list[InferenceResult]:
...
class ExceptHandler(_base_nodes.MultiLineBlockNode, _base_nodes.AssignTypeNode, _base_nodes.Statement):
    ...
    def get_children(self): # -> Generator[NodeNG | AssignName, Any, None]:
        ...
...
class Slice(NodeNG):
    ...
    def getattr(self, attrname, context: InferenceContext | None = ...): # -> list[InferenceResult]:
        ...
...
class Try(_base_nodes.MultiLineWithElseBlockNode, _base_nodes.Statement):
    ...
    def get_children(self): # -> Generator[NodeNG | ExceptHandler, Any, None]:
        ...
...
class FormattedValue(NodeNG):
    ...
    def get_children(self): # -> Generator[NodeNG | JoinedStr, Any, None]:
        ...
