...
class CallSite:
    ...
    @classmethod
    def from_call(cls, call_node, context: InferenceContext | None = ...): # -> Self:
    ...
    def infer_argument(self, funcnode: InferenceResult, name: str, context: InferenceContext): # -> Generator[InferenceResult, None, None] | Generator[InferenceResult, None, InferenceErrorInfo | None] | Iterator[ClassDef] | Iterator[FunctionDef | Instance | Lambda | Module | NodeNG | Any] | Iterator[SuccessfulInferenceResult | ClassDef | FunctionDef | Module | Lambda] | Iterator[Dict] | Iterator[Tuple]:
