...
TOPLEVEL_DECLARED = ...
RESERVED_NAMES = ...
def compile(node, uri, filename=..., default_filters=..., buffer_filters=..., imports=..., future_imports=..., source_encoding=..., generate_magic_comment=..., strict_undefined=..., enable_loop=..., reserved_names=...):
...
class _GenerateRenderMethod:
    ...
    def write_variable_declares(self, identifiers, toplevel=..., limit=...):
    ...
    def write_def_finish(self, node, buffered, filtered, cached, callstack=...):
    ...
    def write_cache_decorator(self, node_or_pagetag, name, args, buffered, identifiers, inline=..., toplevel=...):
