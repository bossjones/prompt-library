...
class RichTraceback:
    ...
    @property
    def traceback(self): # -> list[tuple[Any, Any, Any, Any] | tuple[Any, ...]]:
    ...
    @property
    def reverse_records(self): # -> Iterator[Any]:
        ...

    @property
    def reverse_traceback(self): # -> list[tuple[Any, Any, Any, Any] | tuple[Any, ...]]:
        """Return the same data as traceback, except in reverse order."""
        ...



def text_error_template(lookup=...): # -> Template:
...
def html_error_template(): # -> Template:
