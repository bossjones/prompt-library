...
from typing import Mapping, Optional, Sequence, TYPE_CHECKING, TypeVar, Union
from marimo._output.mime import MIME

if TYPE_CHECKING:
    ...
JSONType: TypeAlias = Union[Mapping[str, "JSONType"], Sequence["JSONType"], str, int, float, bool, object, MIME, None,]
