...
from src.prompt_library.modules.typings import ModelRanking, MultiLLMPromptExecution
...
def record_llm_execution(prompt: str, list_model_execution_dict: list, prompt_template: str = None):
